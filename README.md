...
4. Na následující obrazovce do pole **Your old repository’s clone URL** zadej `https://github.com/lrolecek/javascript2-lekce06-planety` a klikni na zelené tlačítko **Begin import**.
